(function (global) {
  ...
  Store.prototype.startPaymentScorex2 = function () {
    ...
    // Prepare product.
    store.register({
      id: "com.doyban.piratebay.scorex2",
      alias: "Score x2",
      type: store.CONSUMABLE
    });

    // Purchase product.
    store.order("com.doyban.piratebay.scorex2");
    store.refresh();
    store.when("com.doyban.piratebay.scorex2").approved(function (order) {
      order.finish();
      store.refresh();
  ...
  Store.prototype.startPaymentScorex3 = function () {
    ...
    // Prepare product.
    store.register({
      id: "com.doyban.piratebay.scorex3",
      alias: "Score x3",
      type: store.CONSUMABLE
    });

    // Purchase product.
    store.order("com.doyban.piratebay.scorex3");
    store.refresh();
    store.when("com.doyban.piratebay.scorex3").approved(function (order) {
      order.finish();
      store.refresh();
  ...
  Store.prototype.startPaymentScorex4 = function () {
    ...
    // Prepare product.
    store.register({
      id: "com.doyban.piratebay.scorex4",
      alias: "Score x4",
      type: store.CONSUMABLE
    });

    // Purchase product.
    store.order("com.doyban.piratebay.scorex4");
    store.refresh();
    store.when("com.doyban.piratebay.scorex4").approved(function (order) {
      order.finish();
      store.refresh();
  ...
  Store.prototype.startPaymentScorex6 = function () {
    ...
    // Prepare product.
    store.register({
      id: "com.doyban.piratebay.scorex6",
      alias: "Score x6",
      type: store.CONSUMABLE
    });

    // Purchase product.
    store.order("com.doyban.piratebay.scorex6");
    store.refresh();
    store.when("com.doyban.piratebay.scorex6").approved(function (order) {
      order.finish();
      store.refresh();
