(function (global) {
  var YellowEnemy = global.YellowEnemy = function (state, pirate) {
  ...
  YellowEnemy.prototype.killYellowEnemy = function () {
    ...
    if (this.health <= 0) {
      ...
      // Yellow Enemy is moving from right to left.
      ...
      // Yellow Enemy is sailing from left to right.
      else {
        // Stop the pirate, must be here, otherwise this.body.velocity.x would be always 0.
        this.body.velocity.x = 0;
        this.body.velocity.y = 0;
  ...
  YellowEnemy.prototype.boundOut = function (pirate) {
