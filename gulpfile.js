...
// Copy .json files into destination directory.
...
gulp.task('dist', ['copy-index-html', 'copy-audio', 'copy-json', 'minify-css', 'compress', 'concat', 'compress-images']); // Distribution tasks.